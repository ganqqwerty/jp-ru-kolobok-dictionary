...
WRUN-16 — Контракт классификации v6 поддерживает suffix_only и prefix_only только для одного открытого слота на границе. Внутренний слот нельзя убрать вместе с фиксированными словами. Без засвидетельствованного полного раскрытия такая статья остаётся нерешённой для экспорта. Отдельно учитывать владельцев вне контрольных 100: исходный контекст владельца не равен его переводу.
